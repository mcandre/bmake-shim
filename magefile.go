...
var portBasename = fmt.Sprintf("bmake-shim-%s", bmake.Version)

// repoNamespace identifies the Go namespace for this project.
var repoNamespace = "github.com/mcandre/bmake-shim"
...
func Uninstall() error { return mageextras.Uninstall("bmake") }
